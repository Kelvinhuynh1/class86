...
-- Enable RLS but with a policy that allows all access
...
-- Enable realtime for study_links table
alter publication supabase_realtime add table study_links;

-- Remove unique constraint on users table to allow duplicate class codes
